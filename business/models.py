...
class Business(models.Model):
    ...
    availability = models.ForeignKey('Availability', related_name='businesses', on_delete=models.SET_NULL, null=True,
                                     blank=True)
...
class Review(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='reviews')
